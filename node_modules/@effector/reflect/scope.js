...
var effectorReactSSR = require('effector-react/scope');
...
var effectorReactSSR__namespace = /*#__PURE__*/_interopNamespaceDefault(effectorReactSSR);
...
function useBoundFunctions(functions) {
  const scope = effectorReact.useProvidedScope();
...
const reflect = reflectFactory(effectorReactSSR__namespace);
const createReflect = reflectCreateFactory(effectorReactSSR__namespace);
const variant = variantFactory(effectorReactSSR__namespace);
const list = listFactory(effectorReactSSR__namespace);
